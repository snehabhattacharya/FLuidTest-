...
class WidgetContext {
	 ...
	 * @return void
	 */
	public function getNonAjaxWidgetConfiguration() {
	 ...
	 * @return void
	 */
	public function setViewHelperChildNodes(\TYPO3\Fluid\Core\Parser\SyntaxTree\RootNode $viewHelperChildNodes, \TYPO3\Fluid\Core\Rendering\ \TYPO3\Fluid\Core\Rendering\RenderingContextInterface $viewHelperChildNodeRenderingContext) {
